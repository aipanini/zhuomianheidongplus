...
def _menu(state):
    return pystray.Menu(
        pystray.MenuItem("显示 / 隐藏黑洞", lambda: state.push("toggle"), default=True),
        pystray.MenuItem("增大", lambda: state.push("bigger")),
        pystray.MenuItem("缩小", lambda: state.push("smaller")),
        pystray.MenuItem("重置大小", lambda: state.push("reset")),
